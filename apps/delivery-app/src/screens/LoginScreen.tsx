...
export default function LoginScreen({ onLoginSuccess }: { onLoginSuccess: () => void }) {
  ...
  const [email, setEmail] = useState('delivery@mechbazar.com');
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        <View style={styles.card}>
          <View style={logoStyles.logoContainer}>
            ...
            <Text style={logoStyles.logoTagline}>Delivery Partner Console</Text>
          </View>

          <Text style={styles.title}>{isRegisterMode ? 'Register as Partner' : 'Sign In'}</Text>
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              style={styles.input}
              placeholder="rider@mechbazar.com"
              placeholderTextColor="#64748B"
              value={email}
          ...
          >
            {isLoading ? (
              ...
              <Text style={styles.loginButtonText}>{isRegisterMode ? 'Register' : 'Partner Login'}</Text>
            )}
          </TouchableOpacity>
          ...
          {!isRegisterMode && (
            <View style={styles.footer}>
              ...
              <Text style={styles.credentials}>delivery@mechbazar.com / Password@123</Text>
            </View>
          )}
        </View>
      </ScrollView>
